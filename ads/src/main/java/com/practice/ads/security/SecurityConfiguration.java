package com.practice.ads.security;
...
//		.antMatchers(HttpMethod.PUT,"/api/advertisements/*").hasAuthority("USER")
//		.antMatchers(HttpMethod.POST,"/api/advertisements/*").hasAuthority("USER")
//		.antMatchers(HttpMethod.DELETE,"/api/advertisements/*").hasAuthority("USER")
	...
	public static class WebConfig implements WebMvcConfigurer{
		...
		public void addCorsMappings(CorsRegistry registry) {
			...
			registry.addMapping("api/advertisements").allowedOrigins("http://localhost:3000")
			.allowedMethods("OPTIONS", "HEAD", "GET", "PUT", "POST", "DELETE", "PATCH")
			.exposedHeaders("Total-Pages").allowCredentials(true).maxAge(3600);
